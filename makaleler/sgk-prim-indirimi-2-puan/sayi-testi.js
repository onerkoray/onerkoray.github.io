...
var D26 = B.parametre(2026).donemler[0], ASG = D26.asgariBrut;
[[ASG, S.tam(ASG) + " TL (asgari)"], [50000, "50.000 TL"], [100000, "100.000 TL"], [D26.sgkTavan, S.tam(D26.sgkTavan) + " TL (tavan)"]].forEach(function (k) {
...
t.gecsin("yıllık ek yük", "yıllık ek yük " + S.tl(ASG * fark * 12) + " TL");
t.gecsin("aylık", "Asgari ücretli için ayda " + S.tl(ASG * fark) + " TL");
t.dogru("imalat dışı-imalat farkı = 2025'e göre ek yük", Math.abs((yil(ASG, "genel") - yil(ASG, "imalat")) - ASG * fark * 12) < 0.01);
t.bitir();
